...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute bottom-1/4 -right-64 w-[500px] h-[500px] bg-accent/20 rounded-full blur-[120px] mix-blend-multiply opacity-50 dark:opacity-20 animate-pulse-slow" style={{ animationDelay: "2s" }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-display leading-[1.1] mb-6 text-balance">
              ...
              <br />
              <span className="text-foreground/80 text-4xl sm:text-5xl lg:text-6xl mt-2 block">Full Stack Developer.</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-lg leading-relaxed">
              Architecting and delivering enterprise-grade products with React.js & ASP.NET Core. Passionate about scalable solutions.
            </p>
            ...
            <div className="flex items-center gap-6 text-muted-foreground">
              <span className="text-sm font-medium uppercase tracking-wider">Follow Me</span>
              <div className="h-px w-12 bg-border"></div>
              <a href="https://github.com" className="hover:text-primary transition-colors hover:-translate-y-1 transform duration-200"><Github className="w-5 h-5" /></a>
              <a href="https://linkedin.com" className="hover:text-primary transition-colors hover:-translate-y-1 transform duration-200"><Linkedin className="w-5 h-5" /></a>
              <a href="mailto:contact@example.com" className="hover:text-primary transition-colors hover:-translate-y-1 transform duration-200"><Mail className="w-5 h-5" /></a>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[500px] lg:h-[500px]">
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold font-display">Lead Developer</p>
